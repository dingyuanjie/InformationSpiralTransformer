"""Level 7.5.5.1: focused cross-initialization recovery confirmation."""
...
LEVEL_DIR = ROOT / "experiments" / "level7_5_5_1"
STATIC_PREREGISTRATION = LEVEL_DIR / "preregistration.json"
PARENT_RESULT = ROOT / "experiments/level7_5_5/formal/result.json"
PARENT_RESULT_SHA256 = "3f35b3f3f27a335acd56d5daf4973c474bf925b6b383ad5d782ffcecd3a99f34"
PARENT_CLASSIFICATION = "minimum_sufficient_recovery_candidates_found"
EXACT_ARM = PARENT_EXACT_ARM
INTERVENTION_ARMS = [
    "all_memory_frozen",
    "restore_l3_read_fusion", "restore_l3_slot_queries",
]
ALL_ARMS = [EXACT_ARM, *INTERVENTION_ARMS]
SCREEN_DATASET_SEED = 7551000
CONFIRM_DATASET_SEED = 7551001
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="experiments/level7_5_5_1/formal")
...
def formal_protocol_check(args: argparse.Namespace) -> None:
    ...
    if mismatches:
        raise ValueError(f"Formal Level 7.5.5.1 protocol is locked: {mismatches}")
    if args.output != "experiments/level7_5_5_1/formal":
        raise ValueError("Formal Level 7.5.5.1 output path is locked")
...
def plot_parameter_effects(outcomes: list[dict[str, Any]], path: Path) -> None:
    ...
    figure.suptitle("Level 7.5.5.1 focused recovery confirmation", y=0.98)
...
def run_smoke(args: argparse.Namespace) -> int:
    ...
    atomic_save(ROOT / "experiments/level7_5_5_1/smoke/result.json", result)
    print("level7_5_5_1_SMOKE_PASS" if result["passed"] else "level7_5_5_1_SMOKE_FAIL")
